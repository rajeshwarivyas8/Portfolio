...
const Hero = () => {
  return (
   <section className="min-h-screen bg-gradient-to-br from-indigo-950 via-slate-900 to-purple-950 flex flex-col justify-center items-center relative px-6 py-20">
